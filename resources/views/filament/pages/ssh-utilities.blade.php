        ...
        <div class="overflow-hidden">
            <div class="p-6">
                ...
                <div class="prose max-w-none">
                    ...
                    <p>
                        This application integrates with the standard SSH directory structure in
                        your home folder (
                        <code>~/.ssh</code>
                    ...
                    <ul>
                        ...
                        <li>
                            <code>~/.ssh/config.d/</code>
                            - Directory containing individual host configurations
                        </li>
                        <li>
                            <code>~/.ssh/authorized_keys</code>
                            - Public keys that are allowed to connect to this machine
                        </li>
                        <li>
                            <code>~/.ssh/[keyname]</code>
                            - Private keys
                        </li>
                        <li>
                            <code>~/.ssh/[keyname].pub</code>
                            - Public keys
                        </li>
                    </ul>

                    <h3>Working with SSH Keys</h3>
                    <p>The SSH Keys page allows you to:</p>

                    <ol>
                        <li>Create new SSH keys (uses modern Ed25519 algorithm by default)</li>
                        <li>
                            View existing keys from your
                            <code>~/.ssh</code>
                            directory
                        </li>
                    ...
                    <p>The SSH Connections page lets you:</p>

                    <ol>
                        <li>Create and edit SSH connection profiles</li>
                        <li>
                            Save configurations to the standard
                            <code>~/.ssh/config.d/</code>
                            directory
                        </li>
                    ...
                    <p>
                        The SSH Command Runner page allows you to execute commands on remote servers
