    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('bits')
                    ->label('Bits')
                    ->sortable(),
            ...
            ->actions([
                ...
                TableAction::make('view_public')
                    ...
                    ->modalContent(function (SshKey $record) {
                        ...
                        if (file_exists($path)) {
                            $content = "<pre>" . htmlspecialchars(file_get_contents($path)) . "</pre>";
                        } else {
                ...
                TableAction::make('copy_to_server')
                    ...
                    ->modalDescription('This will copy the public key to the selected SSH server authorized_keys file.')
                    ->form([
                    ...
                    ->action(function (SshKey $record, array $data): void {
                        ...
                        if ($process->isSuccessful()) {
                            ...
                            throw new \Exception("Failed to transfer the key: " . $process->getErrorOutput());
                        }
                    }),
                    
                Tables\Actions\DeleteAction::make()
                    ->requiresConfirmation()
                    ->modalDescription('This will permanently delete the SSH key from both the database and the ~/.ssh directory.')
                    ->action(function (SshKey $record): void {
            ...
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\DeleteBulkAction::make()
                        ->requiresConfirmation()
                        ->modalDescription('WARNING: This will permanently delete the selected SSH keys from both the database and the ~/.ssh directory.')
